...
contract NFTPoolBurnAndMint is CCIPReceiver, OwnerIsCreator {
    ...
    function burnAndSendNFT(uint256 tokenId, address newOwner, uint64 chainSelector, address recevier) public returns(bytes32){
        //1:transfer wnft from goal to pool
